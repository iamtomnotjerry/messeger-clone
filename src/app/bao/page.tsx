        ...
        <div className="container mx-auto px-4 py-8">
            ...
            <div className="max-w-3xl mx-auto bg-white rounded-lg shadow-md p-8">
                <div className="text-center mb-6">
                    <Image src="/member1.jpg" alt="Nguyễn Đình Bảo" className="mx-auto rounded-full  mb-4" width={200} height={100} />
                    <h1 className="text-3xl font-bold">Nguyễn Đình Bảo</h1>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-gray-700 leading-relaxed">Nguyễn Đình Bảo is a highly experienced psychotherapist specializing in:</p>
                        <ul className="list-disc pl-6">
                ...
                <div className="mt-8">
                    <h2 className="text-xl font-semibold mb-2">About Nguyễn Đình Bảo</h2>
                    <p className="text-gray-700 leading-relaxed">Nguyễn Đình Bảo is dedicated to helping individuals achieve mental wellness and personal growth. With over 10 years of experience in psychotherapy, he has helped numerous clients overcome obstacles and lead fulfilling lives.</p>
                    <p className="text-gray-700 leading-relaxed">Combining empathy, expertise, and evidence-based approaches, Nguyễn Đình Bảo creates a safe and supportive environment for clients to explore their thoughts, emotions, and behaviors. He believes in the power of collaboration and tailors each therapy session to meet the unique needs and goals of his clients.</p>
                </div>
                <Link href={'/users'}>
